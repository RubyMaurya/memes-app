...
import Fav1 from '../image/fav.png'
import Fav2 from '../image/fav3.png'
...
class AlbumDetail extends Component{
    constructor() {
      ...
      renderImage=() => {
        var imgSource = this.state.isLiked? Like : Liked;
        return (
          <Image
      ...
      renderImage2=() => {
        var imgSource2 = this.state.isFav? Fav1 : Fav2;
        return (
          <Image
            ...
            <TouchableHighlight onPress={() => { this.setModalVisible(true); }}>
                ...
                {this.state.modalVisible &&
                  ...
                  style={{backgroundColor: 'black', flex: 1}}>
                      ...
                      <Image resizeMode={'stretch'} source={{uri:url}} style={{height:400,width:350,alignSelf:'center'}}/>
                    </View>
                          <View
                          style={{backgroundColor: 'black', flex: 1}}>
                  </View>
                      </Modal>}
                    <Image resizeMode={'stretch'} source={{uri:url}} style={styles.imageStyle}/>
                </CardSection>
            </TouchableHighlight>
            <View style={styles.viewStyle}>
                <TouchableOpacity onPress={ () => this.setState({isLiked: !this.state.isLiked }) } 
                style={{marginLeft:20,marginRight:52,paddingTop:3,paddingBottom:3}}>
                {this.renderImage()}
                </TouchableOpacity>
                <TouchableOpacity style={{marginRight:52,paddingTop:3,paddingBottom:3}}>
                    <Image source={require('../image/download2.png')} style={styles.downloadImageStyle}/>
                </TouchableOpacity>
                <TouchableOpacity style={{marginRight:52,paddingTop:5,paddingBottom:6}}
                onPress={()=>{
                  Share.open(shareImageBase64);
                }}>
                    <Image source={require('../image/share.png')} style={{height:30,width:30}}/>
                </TouchableOpacity>
